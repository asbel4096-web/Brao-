        ...
        <div className="grid gap-5">
            ...
            <div className="relative p-6 md:p-8">
              ...
              <div className="text-right">
                ...
                <p className="mt-4 max-w-2xl text-base leading-8 text-white/80 md:text-lg">
                  سجل دخولك وادخل عالم الإعلانات، الرسائل، المفضلة، وإدارة الحساب
                  بشكل احترافي مناسب للهاتف.
                </p>
          ...
          <section className="grid gap-4 md:grid-cols-3">
            ...
            <div className="rounded-[26px] border border-slate-200 bg-white p-5 shadow-sm dark:border-slate-800 dark:bg-slate-900">
              ...
              <p className="mt-2 text-sm leading-7 text-slate-500 dark:text-slate-300">
                بعد تسجيل الدخول ستتمكن من متابعة الرسائل والتنبيهات والإعلانات بسهولة.
              </p>
            </div>
          ...
          <div className="p-6 md:p-8">
            <div className="flex items-center justify-between gap-4">
              <button
                ...
                className="inline-flex items-center gap-2 rounded-[18px] border border-white/15 bg-white/10 px-4 py-3 text-sm font-black text-white backdrop-blur"
              >
        ...
        <section className="rounded-[30px] border border-slate-200 bg-white p-6 shadow-sm dark:border-slate-800 dark:bg-slate-900">
          <div className="flex items-center justify-between gap-4">
            <div className="flex h-24 w-24 items-center justify-center rounded-full bg-slate-100 dark:bg-slate-800">
              <UserCircle2 className="h-14 w-14 text-[#2F49C8]" />
            </div>
          ...
          <div className="mt-6 grid gap-4 md:grid-cols-3">
            <div className="rounded-[24px] bg-slate-50 p-5 text-center dark:bg-slate-800">
              <div className="text-3xl font-black text-[#2F49C8]">حساب</div>
              <div className="mt-2 text-sm font-bold text-slate-500 dark:text-slate-300">
                موثق بالتسجيل الحالي
              </div>
            </div>

            <div className="rounded-[24px] bg-slate-50 p-5 text-center dark:bg-slate-800">
              <div className="text-3xl font-black text-[#F58233]">جاهز</div>
              <div className="mt-2 text-sm font-bold text-slate-500 dark:text-slate-300">
                لإدارة الإعلانات والرسائل
              </div>
            </div>

            <div className="rounded-[24px] bg-slate-50 p-5 text-center dark:bg-slate-800">
              <div className="text-3xl font-black text-emerald-600">آمن</div>
              <div className="mt-2 text-sm font-bold text-slate-500 dark:text-slate-300">
                دخول محفوظ على الجهاز
              </div>
            </div>
          </div>

          {message ? (
            <div className="mt-5 rounded-[22px] bg-slate-100 px-4 py-4 text-center text-sm font-black text-slate-700 dark:bg-slate-800 dark:text-slate-200">
              {message}
            </div>
          ) : null}
        </section>
