          ...
          <div className="card overflow-hidden">
            ...
            <div className="p-6">
              ...
              <div className="mt-4 grid gap-3 rounded-[28px] bg-slate-50 p-4 text-sm text-slate-600 sm:grid-cols-2 lg:grid-cols-4">
                ...
                <div><strong>الوقود:</strong> {listing.fuel || listing.fuelType || '-'}</div>
        ...
        <aside className="space-y-6">
          <div className="card p-6">
            ...
            <div className="mt-6 grid gap-3">
              <a href={normalizePhone(listing.sellerPhone || listing.phone) ? `tel:${normalizePhone(listing.sellerPhone || listing.phone)}` : '#'} className="btn-secondary gap-2"><Phone size={18} />اتصال مباشر</a>
