...
export default function ListingDetailsPage() {
  ...
  const safeWhatsapp = (listing.whatsapp || listing.phone || '').replace(/\D/g, '');
        ...
        <div className="space-y-6">
          ...
          {(listing.address || listing.mapLink) ? (
            <div className="card p-6">
              ...
              {listing.mapLink ? <a href={listing.mapLink} target="_blank" className="btn-secondary mt-4">فتح في الخرائط</a> : null}
            </div>
          ) : null}
        ...
        <aside className="space-y-6">
          <div className="card p-6">
            ...
            <div className="mt-6 grid gap-3">
              ...
              <a href={safeWhatsapp ? `https://wa.me/${safeWhatsapp}` : '#'} className="btn-primary gap-2"><MessageCircle size={18} />واتساب</a>
