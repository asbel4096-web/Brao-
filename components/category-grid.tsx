...
const iconMap: Record<string, any> = {
  ...
  'tires-rims': CircleDashed,
  parts: Cog,
  'electrical-parts': Settings2,
  'body-paint': PaintRoller,
  'mechanic-workshops': Wrench,
  'car-electrician': Settings2,
  'accident-cars': LifeBuoy,
  'used-parts': Cog
};
  ...
  return (
    <section className="container py-10">
      <div>
        ...
        <p className="section-subtitle">واجهة احترافية مستوحاة من تجربة الأسواق الكبيرة لكن بأسلوب براتشو كار وتركيز كامل على قطاع السيارات والخدمات في ليبيا.</p>
      </div>
